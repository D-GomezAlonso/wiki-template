...
export const Home = () => {
  return (
    <div className="flex flex-col px-12 py-7 gap-12">
      <Card>
        <>
          ...
          <p className="text-center">
            A fan made comprehensive source of information about the game.
            Currently we have 124 articles, and 56 pages.
          </p>
        </>
      </Card>
      ...
      <Card headerText="About">
        <p className="px-5">
          Lost in the endless expanse of space, you must fight off endless
          hordes of inter-dimensional beings to claim a few more brief moments
          of life. Picayune Dreams will challenge your skill, endurance, and
          perseverance through a mind warping, psychedelic, bullet hell
          nightmare. This psychedelic, space-faring action roguelike looks to
          merge the best elements of Bullet Heavens + Bullet Hells.
        </p>
      </Card>
